  ...
  return (
    ...
    <div className="fixed bottom-6 right-4 z-50 flex flex-col items-center">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        aria-label="Chat with Neo on WhatsApp"
        className="flex items-center justify-center w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] text-white shadow-lg shadow-black/30 transition-all duration-300 hover:scale-110 active:scale-95"
      >
      ...
      >
        <div className="pt-3">
          <button
            ...
            className="flex items-center justify-center w-12 h-12 rounded-full bg-gold hover:bg-yellow-700 text-white shadow-lg shadow-black/30 transition-all duration-300 hover:scale-110 active:scale-95"
          >
