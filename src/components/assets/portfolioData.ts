...
export const qualifications: Qualification[] = [
  {
    ...
    duties:
      "Completed the National Senior Certificate at Steynsrus Combined School, building a strong foundation in mathematics, science, and computer literacy. Developed essential skills in communication, critical thinking, and problem-solving that laid the groundwork for a career in technology.",
